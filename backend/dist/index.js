...
const aizap_1 = __importDefault(require("./router/aizap"));
const cors_1 = __importDefault(require("cors"));
const dotenv_1 = __importDefault(require("dotenv"));
const userSecret_1 = require("./router/userSecret");
...
app.use("/api/v2/zap", aizap_1.default);
app.use("/api/v2", userSecret_1.userSecret);
